    ...
    <form class="max-w-sm mx-auto" method="post" action="{{route('form.store')}}">
        ...
        <div class="mb-5">
            ...
            <input type="text" id="email"
                ...
                placeholder="Enter Your Name" name="fullname"  value="{{old('fullname')}}"/>
        </div>
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <input type="password" id="repeat-password"
                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                placeholder="Enter Your Password"  name="password" value="{{old('')}}"/>
        </div>
        <div class="mb-5">
            ...
            <input type="number" id="repeat-password"
                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                placeholder="Enter Your Number" name="phone" value="{{old('phone')}}"/>
        </div>
